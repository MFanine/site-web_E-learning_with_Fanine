...
<head>
	...
	<title>Préparez-vous pour GATE sur ÉducatifExpress</title>
...
<!-- NAVIGATION -->
	<header>
		<div class="nav" id="nav">
			<div id="learned-logo">
			<a href="../index.php"><img src="../images/icon/logoEE.png" style="width: 120px;"></a></div>
			<div class="switch-tab" id="switch-tab" onclick="switchTAB()"><img src="../images/icon/menu.png"></div>
			<ul id="list-switch">
				<li><a href="jee.php"><img src="../images/courses/d1.png" class="icon">BTS</a></li>
				<li><a href="#"><img src="../images/courses/paper.png" class="icon">GATE</a></li>
				<li><a href="computer_courses.php"><img src="../images/courses/computer.png" class="icon">Cours d'informatique</a></li>
				<li><a href="computer_courses.php#data"><img src="../images/courses/data.png" class="icon">Structures de données</a></li>
...
<!-- Main Title of the Page -->
	<div class="title">
		<span>Préparez-vous aux examens GATE sur ÉducatifExpress</span>
		<div class="shortdesc">
			<p>Apprenez de LearnEd pour de meilleures études supérieures dans<br> Indian Institutes of Technologies (IIT)</p>
		</div>
	</div>
...
<!-- Courses Available -->
	<div class="inbt">
	Accélérez votre carrière avec les programmes GATE
	</div>
...
<!-- SAMPLE PAPERS -->
	<div class="title2" id="sample_papers">
		<span>National BTS 2018-23</span>
		<div class="shortdesc2">
			<p>Pratiquez de plus en plus de questions papiers</p>
		</div>
	</div>

	<div class="sample">
		<ul>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2018 Set-A</a></li>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2018 Set-B</a></li>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2018 Set-C</a></li>
		</ul>
		<ul>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2019 Set-A</a></li>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2019 Set-B</a></li>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2019 Set-C</a></li>
		</ul>
		<ul>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2020 Set-A</a></li>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2020 Set-B</a></li>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2020 Set-C</a></li>
		</ul>
	</div>
	<div class="sample lastSample">
		<ul>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2021 Set-A</a></li>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2021 Set-B</a></li>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2021 Set-C</a></li>
		</ul>
		<ul>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2022 Set-A</a></li>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2022 Set-B</a></li>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2022 Set-C</a></li>
		</ul>
		<ul>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2023 Set-A</a></li>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2023 Set-B</a></li>
			<li><a href="../samplePapers/p1.pdf" target="_blank">National BTS 2023 Set-C</a></li>
		</ul>
	</div>
