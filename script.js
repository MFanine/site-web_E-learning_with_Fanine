...
function showMenu(){
  let menu = document.querySelector('.menu-extended');
  menu.classList.add('menu-extended-active');
}
buttonn.addEventListener('click' ,showMenu())

function hideMenu(){
  let menu = document.querySelector('.menu-extended');
  menu.classList.remove('menu-extended-active');
}
divh.addEventListener('click' ,hideMenu())
